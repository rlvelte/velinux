...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      local meta='%f' clean='%76F' modified='%178F' untracked='%39F' conflicted='%196F'
    else
  ...
  # ┌─ fvm / luaenv / jenv / plenv / perlbrew / phpenv / scalaenv / haskell_stack ──
